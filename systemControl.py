...
class SystemControl:
    def __init__(self, beVerbose):
        ...
        elif LINUX_ARCH_SYSTEMD in platform.platform():
            self.currentOSIdentifier = LINUX_ARCH_SYSTEMD
        else:
    ...
    def setSleep(self):
        ...
        elif self.currentOSIdentifier == LINUX_ARCH_SYSTEMD:
